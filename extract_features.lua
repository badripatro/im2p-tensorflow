...
local DenseCapModel=require 'densecap.DenseCapModel'
...
--]]
-- Read the text file of image paths
  print('loading Image path json file: ', opt.input_txt)
  path = read_json(opt.input_txt)
  local image_paths=path['images_path']
